...
public class BluetoothLeService extends Service implements Serializable{
    ...
    public final static String INT_DATA =
            "com.example.bluetooth.le.INT_DATA";
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            if (data != null && data.length > 0) {
                ...
                intent.putExtra(INT_DATA, stringBuilder.toString());
     ...
     *
0    * @return Return true if the connection is initiated successfully. The connection result
